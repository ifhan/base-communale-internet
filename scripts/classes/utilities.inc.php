...
/**
 * Retourne la chaine passee en parametre dans un tableau de mots en conservant l'ordre de la chaine
 * 
 * @param type $string
 * @return type 
 */
...
/**
 * Supprime les entrees vides du tableau
 * 
 * @param type $array
 * @return array 
 */
function array_non_empty($array)
{
     ...
     foreach ($array as $a)
     {
          if ((!empty($a)) && (strlen($a) >= 3)) { array_push($retour, trim($a)); }
     }
     return $retour;
}

/**
 * Gestion centralisee des messages d'erreurs
 * 
 * @param type $niveau
 * @param type $message 
 */
