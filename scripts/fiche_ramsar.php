...
require_once 'classes/Ramsar.class.php';
...
$ramsar = new Ramsar();
$ramsar->getRamsarByIdRegional($id_regional);
...
<table class="cadre_plein">
    <tr>
        <td>Nom&nbsp;:</td>
        <td><strong><?=$ramsar->nom?></strong></td>
    </tr>
    <tr>
        <td>Identifiant r&eacute;gional&nbsp;:</td>
        <td><strong><?=$ramsar->id_regional?></strong></td>
    </tr>
        <tr>
        <td>Surface calcul&eacute;e dans le SIG&nbsp;:</td>
        <td><strong><?=$ramsar->surf_sig_l93?> ha</strong></td>
    </tr>
    <tr>
