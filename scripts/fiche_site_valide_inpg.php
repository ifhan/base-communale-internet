...
$site_inpg->getSiteInpgValideByIdRegional($id_regional);
...
<table class="cadre_plein">
    ...
    <tr>
        <td>Date de validation par la <abbr title="Commission Nationale du Patrimoine Géologique">CNPG</abbr>&nbsp;:</td>
        <td>
            <strong><?=$site_inpg->valid_cnpg?></strong>
        </td>
    </tr>    
    <tr>
